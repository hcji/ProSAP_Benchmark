...
euclidean = pd.read_csv('Result/Sav_STS/Chebyshev.csv')
...
plt.plot(np.arange(1, 101) - euclidean_ifkin[:100], euclidean_ifkin[:100], label='Chebyshev')
plt.plot(np.arange(1, 101) - euclidean_rep1_ifkin[:100], euclidean_rep1_ifkin[:100], label='Chebyshev replicate 1')
plt.plot(np.arange(1, 101) - euclidean_rep2_ifkin[:100], euclidean_rep2_ifkin[:100], label='Chebyshev replicate 2')
