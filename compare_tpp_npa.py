...
nparc = pd.read_csv('Result/Sav_STS/NPARC.csv')
chebyshev = pd.read_csv('Result/Sav_STS/Chebyshev.csv')
euclidean = pd.read_csv('Result/Sav_STS/Euclidean.csv')
cosine = pd.read_csv('Result/Sav_STS/Cosine.csv')
cityblock = pd.read_csv('Result/Sav_STS/Cityblock.csv')
